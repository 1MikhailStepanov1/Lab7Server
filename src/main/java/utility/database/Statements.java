...
public class Statements {
    ...
    public static final String UPDATE_WORKER = "UPDATE workers312709 SET name=?, xCoordinate=?, yCoordinate=?, salary=?, startDate=?, endDate=?, pos=?, height=?, weight=?, owner=? WHERE id=?";
