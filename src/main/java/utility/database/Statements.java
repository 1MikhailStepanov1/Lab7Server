...
public class Statements {
    ...
    public static final String ADD_WORKER = "INSERT INTO workers312709 (id, name, coordinateX, coordinateY, salary, startDate, endDate, pos, height, weight, owner) VALUES(?,?,?,?,?,?,?,?,?,?,?)";
    public static final String UPDATE_WORKER = "UPDATE workers312709 SET name=?, coordinateX=?, coordinateY=?, salary=?, startDate=?, endDate=?, pos=?, height=?, weight=? WHERE id=?";
